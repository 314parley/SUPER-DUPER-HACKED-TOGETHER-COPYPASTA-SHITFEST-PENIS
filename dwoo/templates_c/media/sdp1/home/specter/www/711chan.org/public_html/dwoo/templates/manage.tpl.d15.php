...
<?php if ((defined("KU_HTML5GRAPH") ? KU_HTML5GRAPH : null)) {
?>
    <script src="lib/javascript/RGraph.common.core.js" ></script>
    <script src="lib/javascript/RGraph.common.effects.js" ></script>
    <script src="lib/javascript/RGraph.common.key.js" ></script>
    <script src="lib/javascript/RGraph.bar.js" ></script>
    <script>
        window.onload = function ()
        {
<?php echo $this->scope["javascript"];?>
