...
<table class="postform">
	...
	<tr>
		...
		<td>
			{strip}<input type="text" name="subject" size="35" maxlength="75" accesskey="s" autocomplete="off"/>&nbsp;<input type="submit" value="
	...
	{/if}
		<tr>
			...
			<td>
				<input type="password" name="postpassword" size="8" accesskey="p" autocomplete="off"/>&nbsp;{t}(for post and file deletion){/t}
			</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="rules">
				<ul style="margin-left: 0; margin-top: 0; margin-bottom: 0; padding-left: 0;">
					...
					<li>{t}Maximum file size allowed is{/t} {math "round(x/1024/1024)" x=$board.maximagesize} MB.</li>
